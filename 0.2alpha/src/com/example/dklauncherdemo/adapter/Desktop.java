...
import com.example.dklauncherdemo.activitys.MockHome;
...
public class Desktop {
	...
	public void SetDefaultLauncher() {
		...
		try {
			...
			paramIntent1.setComponent(new ComponentName(
	...
	public void startHuaweiSettingActOfDefLauncher() {
		...
		localIntent4.putExtra("preferred_app_package_name",
				context.getPackageName());
		localIntent4.putExtra("preferred_app_class_name", context.getClass()
				.getName());
